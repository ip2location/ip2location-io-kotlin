...
myst_html_meta = {
    "description": "IP2Location.io Kotlin module enables user to get the geolocation information from IP2Location.io API.",
    "keywords": "IP2Location, Geolocation, IP location, Kotlin",
...
html_title = "IP2Location.io Kotlin"

# html_baseurl = "https://ip2location-io-kotlin.readthedocs.io/en/latest/"